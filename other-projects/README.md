...
Unrelated sites that were merged into this branch from separate sessions. They
are kept here for reference, isolated from the main project (the investment
**command-center/** app, deployed via **docs/**).
